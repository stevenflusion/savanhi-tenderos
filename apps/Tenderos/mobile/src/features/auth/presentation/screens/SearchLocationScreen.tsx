...
export default function SearchLocationScreen() {
  ...
  const selectSuggestion = (suggestion: Suggestion) => {
    ...
    authLocationSearchState.lat = lat;
    authLocationSearchState.lng = lng;
    authLocationSearchState.address = address;
    router.back();
  };
    ...
    <View className="flex-1 bg-white">
      ...
      >
        ...
        <View className="px-6" style={{ paddingBottom: insets.bottom + 16 }}>
          {error ? (
            <Text className="mb-3 text-sm text-red-500 text-center">{error}</Text>
          ) : null}
